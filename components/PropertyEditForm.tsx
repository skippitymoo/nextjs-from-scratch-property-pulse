...
const PropertyEditForm = () => {
  ...
  const [fields, setFields] = useState<PropertyType | null>(null);
  ...
  const handleChange = (
    ...
    if (name.includes(".")) {
      ...
      type PropertyTypeKey = keyof PropertyType;

      setFields((prevFields) => {
        if (!prevFields) return prevFields;
        return {
          ...prevFields,
          [outerKey as PropertyTypeKey]: {
            ...(prevFields[outerKey as PropertyTypeKey] as object),
            [innerKey]: value,
          },
        };
      });
