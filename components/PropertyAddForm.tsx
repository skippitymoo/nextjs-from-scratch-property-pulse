"use client";
import { PropertyAddType } from "@/types/app-types";
...
const PropertyAddForm = () => {
  ...
  const handleChange = (
    ...
    if (name.includes(".")) {
      ...
      type PropertyAddTypeKey = keyof PropertyAddType;

      setFields((prevFields) => {
        return {
          ...prevFields,
          [outerKey as PropertyAddTypeKey]: {
            ...(prevFields[outerKey as PropertyAddTypeKey] as object),
            [innerKey]: value,
          },
        };
      });
